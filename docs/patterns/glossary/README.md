...
```kotlin
String.eq()
// arrow.instances.StringKt$eq$1@728ae6e6
```

```kotlin
Option.functor()
// arrow.core.Instance_arrow_instances_OptionFunctorInstanceKt$functor$1@52092fc0
```

```kotlin
MapK.semigroup<String, Int>(Int.semigroup())
// arrow.data.Instance_arrow_instances_MapKSemigroupInstanceKt$semigroup$1@168d823
```

```kotlin
Either.monadError<Throwable>()
// arrow.core.Instance_arrow_instances_EitherMonadErrorInstanceKt$monadError$1@1bc1c081
```

```kotlin
ListK.traverse()
// arrow.data.Instance_arrow_instances_ListKTraverseInstanceKt$traverse$1@19cab9ee
```
...
ListK.functor()
// arrow.data.Instance_arrow_instances_ListKFunctorInstanceKt$functor$1@7197ca88
```
