...
Option.monadError()
// arrow.core.Instance_arrow_instances_OptionMonadErrorInstanceKt$monadError$1@4af133e4
```

```kotlin
Try.monadError()
// arrow.core.Instance_arrow_instances_TryMonadErrorInstanceKt$monadError$1@3450d67f
```

```kotlin
Either.monadError<NukeException>()
// arrow.core.Instance_arrow_instances_EitherMonadErrorInstanceKt$monadError$1@5fa8a0b4
```
